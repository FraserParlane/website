<table class="years">
    ...
    <tr>
        <td>
            <h3>Technical Program Manager & Software Engineer, internship, Google</h3>
    ...
    <tr>
        <td>
            <h3>[UBC teaching and mentorship]</h3>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus semper lacus vitae nisl pretium, a pulvinar justo eleifend. Etiam dignissim dui enim. Fusce suscipit tempus erat tristique dictum. Etiam commodo urna nec nibh ullamcorper, id rutrum leo cursus. Sed hendrerit laoreet eros, eget tristique ligula rutrum et.
        </td>
        <td>YEAR</td>
    </tr>
    <tr>
        <td>
            <h3>[Research assistant - France]</h3>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus semper lacus vitae nisl pretium, a pulvinar justo eleifend. Etiam dignissim dui enim. Fusce suscipit tempus erat tristique dictum.
        </td>
        <td>YEAR</td>
    </tr>
    <tr>
